...
class ItanoAnalysis:
    ...
    def density(self, x, y, radius=None):#F1, plasma density
        """
    ...
    def dEavg(self, u, detun=None, offset=None):#F2, energy rate of Sx,(8)
        """
    ...
    def dEavg_fine(self, u, detun=None, offset=None,num=50):#F3, fine of F2
        """
    ...
    def dEavg_no_rotating_wall(self, u, detun=None, offset=None):#F4, energy rate without rotating wall??(10)
        """
